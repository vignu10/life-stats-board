// StatusScreen.tsx - Main status window inspired by Solo Leveling
...
const styles = StyleSheet.create({
  ...
  levelBox: {
    ...
    width: '22%', // Responsive width as a percentage
    aspectRatio: 1, // Keep it square regardless of screen size
  },
  levelLabel: {
    color: '#fff',
    fontSize: 12,
